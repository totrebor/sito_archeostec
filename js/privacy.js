...
<div class="container-d-flex">
    ...
    <p class="fs-3 title-text-psl"><b>Cookies</b></p>
        <div class="col-12">
            <ul>
                <li>Premesse ArcheOs Tec di Alessandra Mazzucchi, con sede legale in Via Matteotti 7 in Gornate Olona VA, in qualità di titolare del trattamento dei dati (“Titolare”), pubblica la seguente Cookie Policy, informativa per il trattamento dei cookie utilizzati dal sito Internet raggiungibile all’URL: http://www.archeostec.it (“Sito”). Per tutto quanto non previsto dalla Cookie Policy si rinvia all'informativa in materia di trattamento dati. Utilizzando il sito l'utente accetta che vengano installati sul suo dispositivo i cookie "proprietari" e "di terze parti" indicati di seguito. Disabilitando tutti o alcuni cookie, alcune funzionalità del sito potrebbero non operare correttamente.</li>
